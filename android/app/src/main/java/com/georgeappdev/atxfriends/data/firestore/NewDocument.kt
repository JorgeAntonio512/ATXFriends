 ...
 * up and found missing. This is the single `set` call in app code (allow-listed by
 * NoWholeDocumentWritesTest); on an existing document it would replace every field.
 */
